...
(function() {
  ...
  async function deleteExamResult(resultId) {
    return request('/api/exam-results/' + encodeURIComponent(resultId) + '/delete', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
  ...
  async function toggleStudent(studentId) {
    return request('/api/students/' + encodeURIComponent(studentId) + '/toggle', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
  ...
  async function resetStudentPassword(studentId) {
    return request('/api/students/' + encodeURIComponent(studentId) + '/reset-password', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
  ...
  async function getStudentProfile(studentId) {
    return request('/api/students/' + encodeURIComponent(studentId) + '/profile');
  }

  async function adminRegisterCourses(payload) {
    return request('/api/registrations/admin', {
      method: 'POST',
      body: JSON.stringify(payload)
    });
  }
  ...
  async function toggleStaff(staffId) {
    return request('/api/staff/' + encodeURIComponent(staffId) + '/toggle', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
  ...
  async function shortlistJobApplication(jobId) {
    return request('/api/job-applications/' + encodeURIComponent(jobId) + '/shortlist', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }

  async function rejectJobApplication(jobId) {
    return request('/api/job-applications/' + encodeURIComponent(jobId) + '/reject', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
